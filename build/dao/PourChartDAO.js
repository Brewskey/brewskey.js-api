...
var PourChartDAO = /*#__PURE__*/function (_RestDAO) {
  _inherits(PourChartDAO, _RestDAO);
  function PourChartDAO() {
    var _this;
    _classCallCheck(this, PourChartDAO);
    _this = _callSuper(this, PourChartDAO, [{
      entityName: _constants.DAO_ENTITIES.POUR_CHART,
      translator: new _DefaultTranslator["default"]()
    }]);
    _defineProperty(_assertThisInitialized(_this), "fetchChartData", function (params) {
      var queryString = _qs["default"].stringify(_objectSpread(_objectSpread({}, params), {}, {
  ...
  return _createClass(PourChartDAO);
}(_RestDAO2["default"]);
var _default = exports["default"] = new PourChartDAO();