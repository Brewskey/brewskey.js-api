...
var _excluded = ["__custom_key__"],
  _excluded2 = ["orderBy", "skip", "take"];
...
var ODataDAO = /*#__PURE__*/function (_BaseODataDAO) {
  ...
  function ODataDAO() {
    ...
    _this = _callSuper(this, ODataDAO, [].concat(args));
  ...
  _createClass(ODataDAO, [{
    ...
    value: function deleteByID(id) {
      ...
      this.__emitChanges();
      this.__resolveSingle(this.__buildHandler().find(this.__reformatIDValue(stringifiedID)), /* params */{}, 'DELETE').then(function () {
    ...
    value: function __countCustom(getOHandler) {
      ...
      var cacheKey = this._getCacheKey(_objectSpread(_objectSpread({}, baseQueryOptions), {}, {
        __custom_key__: key
      }));
    ...
    value: function fetchMany() {
      ...
      var countQueryKey = this._getCacheKey(_objectSpread(_objectSpread({}, this._getCountQueryOptions(queryOptions)), {}, {
        __custom_key__: ''
      }));
    ...
    value: function fetchAll(queryOptions) {
      ...
      return this.count(queryOptions).map(function (count) {
        return _toConsumableArray(Array(Math.ceil(count / STANDARD_PAGE_SIZE))).map(function (_, index) {
          var skip = STANDARD_PAGE_SIZE * index;
          var loader = _this6.fetchMany(_objectSpread(_objectSpread({}, queryOptions), {}, {
            skip: skip,
    ...
    value: function fetchSingle(queryOptions) {
      var combinedQueryOptions = _objectSpread(_objectSpread({
        orderBy: [{
          column: 'id',
          direction: 'desc'
        }]
    ...
    value: function __fetchCustom(handler, queryOptions) {
      var key = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var cacheKey = this._getCacheKey(_objectSpread(_objectSpread({}, queryOptions), {}, {
        __custom_key__: key
      }));
      ...
      this._runFlushCache = (0, _debounce["default"])(function () {
        ...
        _this12._countLoaderByQuery = _this12._rebuildMap(_this12._countLoaderByQuery, _this12._currentCountQueries, function (queryOptions) {
          return _this12._hydrateCount(function (countQueryOptions) {
            return _this12.__buildHandler(_objectSpread(_objectSpread({}, queryOptions), countQueryOptions));
          }, queryOptions);
        });
    ...
    value: function _rehydrateCustom() {
      ...
      this._customHandlerByQuery.forEach(function (_, key) {
        ...
        var _JSON$parse = JSON.parse(key),
          ...
          queryParams = _objectWithoutProperties(_JSON$parse, _excluded);
    ...
    value: function _hydrateCount(getOHandler, queryOptions) {
      ...
      this.__emitChanges();
      this.__resolve(getOHandler(_objectSpread(_objectSpread({}, baseQueryOptions), {}, {
        shouldCount: true,
        take: 0
      }))).then(function (result) {
    ...
    value: function _getCountQueryOptions() {
      ...
      var orderBy = queryOptions.orderBy,
        ...
        countQueryOptions = _objectWithoutProperties(queryOptions, _excluded2);
...
var _default = exports["default"] = ODataDAO;