  ...
  _createClass(TapDAO, [{
    ...
    value: function countLeaderboard(tapID, duration, queryOptions) {
      ...
      return this.__countCustom(function (countQueryOptions) {
        var handler = _this.__buildHandler(_objectSpread(_objectSpread({}, queryOptions), countQueryOptions), false).find(_this.__reformatIDValue(stringifiedID));
...
var _default = exports["default"] = new TapDAO();