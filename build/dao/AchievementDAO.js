...
var AchievementDAO = /*#__PURE__*/function (_ODataDAO) {
  _inherits(AchievementDAO, _ODataDAO);

  var _super = _createSuper(AchievementDAO);
  ...
  _createClass(AchievementDAO, [{
    ...
    value: function fetchAchievementCounters(userID) {
      var queryOptions = {
        apply: "filter((owner/id eq '".concat(userID, "'))") + '/groupby((achievementType),aggregate($count as total))'
      };
...
var _default = new AchievementDAO();
