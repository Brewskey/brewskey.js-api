...
function (_ODataDAO) {
  ...
  function KegDAO() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(KegDAO).call(this, {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fetchKegByTapID", function (tapId) {
