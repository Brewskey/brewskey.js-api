...
var _excluded = ["createdBy", "isDeleted", "lastEdited", "lastEditedBy", "location", "organization", "temperature"];
...
var DeviceTranslator = /*#__PURE__*/function (_DefaultTranslator) {
  _inherits(DeviceTranslator, _DefaultTranslator);
  function DeviceTranslator() {
    _classCallCheck(this, DeviceTranslator);
    return _callSuper(this, DeviceTranslator, arguments);
  }
  _createClass(DeviceTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(DeviceTranslator.prototype), "fromApi", this).call(this, apiValue)), {}, {
...
var _default = exports["default"] = DeviceTranslator;