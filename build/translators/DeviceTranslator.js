...
function (_DefaultTranslator) {
  ...
  function DeviceTranslator() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DeviceTranslator).apply(this, arguments));
  }

  _createClass(DeviceTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread({}, _get(_getPrototypeOf(DeviceTranslator.prototype), "fromApi", this).call(this, apiValue), {
