...
var TapsTranslator = /*#__PURE__*/function (_DefaultTranslator) {
  _inherits(TapsTranslator, _DefaultTranslator);
  function TapsTranslator() {
    _classCallCheck(this, TapsTranslator);
    return _callSuper(this, TapsTranslator, arguments);
  }
  _createClass(TapsTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(TapsTranslator.prototype), "fromApi", this).call(this, apiValue)), {}, {
    ...
    value: function toForm(_ref) {
      var description = _ref.description,
        device = _ref.device,
        disableBadges = _ref.disableBadges,
        hideLeaderboard = _ref.hideLeaderboard,
        hideStats = _ref.hideStats,
        id = _ref.id,
        isPaymentEnabled = _ref.isPaymentEnabled,
        location = _ref.location,
        requiresPourPrivilege = _ref.requiresPourPrivilege;
      return {
        ...
        requiresPourPrivilege: requiresPourPrivilege
      };
    }
  }]);
  return TapsTranslator;
}(_DefaultTranslator2["default"]);
var _default = exports["default"] = TapsTranslator;