...
var BeverageTranslator = /*#__PURE__*/function (_DefaultTranslator) {
  _inherits(BeverageTranslator, _DefaultTranslator);
  function BeverageTranslator() {
    _classCallCheck(this, BeverageTranslator);
    return _callSuper(this, BeverageTranslator, arguments);
  }
  _createClass(BeverageTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(BeverageTranslator.prototype), "fromApi", this).call(this, apiValue)), {}, {
...
var _default = exports["default"] = BeverageTranslator;