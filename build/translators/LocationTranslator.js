...
var LocationTranslator = /*#__PURE__*/function (_DefaultTranslator) {
  ...
  function LocationTranslator() {
    ...
    return _callSuper(this, LocationTranslator, arguments);
  }
  _createClass(LocationTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(LocationTranslator.prototype), "fromApi", this).call(this, apiValue)), {}, {
        geolocation: apiValue.geolocation && _objectSpread(_objectSpread({}, apiValue.geolocation), {}, {
...
var _default = exports["default"] = LocationTranslator;