...
var SchedulesTranslator = /*#__PURE__*/function (_DefaultTranslator) {
  ...
  function SchedulesTranslator() {
    ...
    return _callSuper(this, SchedulesTranslator, arguments);
  }
  _createClass(SchedulesTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(SchedulesTranslator.prototype), "fromApi", this).call(this, apiValue)), {}, {
    ...
    value: function toApi(mutator) {
      return _objectSpread(_objectSpread({}, mutator), {}, {
...
var _default = exports["default"] = SchedulesTranslator;