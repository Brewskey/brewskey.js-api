...
var PourTranslator = /*#__PURE__*/function (_DefaultTranslator) {
  _inherits(PourTranslator, _DefaultTranslator);
  function PourTranslator() {
    _classCallCheck(this, PourTranslator);
    return _callSuper(this, PourTranslator, arguments);
  }
  _createClass(PourTranslator, [{
    key: "fromApi",
    value: function fromApi(apiValue) {
      return _objectSpread(_objectSpread({}, _get(_getPrototypeOf(PourTranslator.prototype), "fromApi", this).call(this, apiValue)), {}, {
...
var _default = exports["default"] = PourTranslator;