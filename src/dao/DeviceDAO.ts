...
export type ParticleAttributes = {
  cellular: string | null | undefined;
  connected: boolean;
  currentBuildTarget: string | null | undefined;
  functions: Array<string>;
  id: string;
  imei: string | null | undefined;
  lastApp: string | null | undefined;
  lastHeard: Date;
  lastIccid: string | null | undefined;
...
class DeviceDAOImpl extends ODataDAO<Device, DeviceMutator> {
  constructor() {
    super({
  ...
  fetchParticleAttributes(deviceID: EntityID): Promise<ParticleAttributes> {
    ...
    return this.__fetchCustom(handler, {});
  }
}

export const DeviceDAO = new DeviceDAOImpl();
